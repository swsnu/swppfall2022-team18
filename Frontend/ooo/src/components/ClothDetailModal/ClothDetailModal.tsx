        ...
        <div className='ClothDetailModal'>
            ...
            <div className="ClothDetailModalTop">
                ...
                <div className="ClothLable-modal">
                    <text id='type-label-modal'><b>종류</b></text>
                    <text id='type-text-modal'>{'니트'}</text><br></br>
                    <text id='color-label-modal'><b>색상</b></text>
                    <text id='color-text-modal'>{'회색'}</text><br></br>
                    <text id='stripe-label-modal'><b>무늬</b></text>
                    <text id='stripe-text-modal'>{'없음'}</text><br></br>
                </div>
                <button id="move-recommend-button" onClick={()=>clickMoveToRecommendedStyleHandler()}>Get Recommendation</button>
            </div>
        </div>
    )
}
